...
**Canonical tracking branch:** `main` documentation. Active implementation branch may differ.
...
This tracker and `MEETVIA_MASTER_SPEC.md` are retained in `main` so future implementation can use the repository as the canonical reference without requiring the source ZIP to be resent.
