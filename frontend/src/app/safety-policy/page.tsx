...
const SLUG = 'safety-policy';

export const metadata: Metadata = {
  title: 'Safety Policy | Meetvia',
  description:
    'Read our safety policy to understand how Meetvia ensures safe and professional experiences for all users.',
  openGraph: {
    title: 'Safety Policy | Meetvia',
    description:
      'Read our safety policy to understand how Meetvia ensures safe and professional experiences for all users.',
    type: 'website',
    images: [{ url: 'https://meetvia.com/og-image.png', width: 1200, height: 630, alt: 'Meetvia Safety Policy' }],
  },
};
