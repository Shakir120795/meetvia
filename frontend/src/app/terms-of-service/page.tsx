...
export const metadata: Metadata = {
  title: 'Terms of Service | Meetvia',
  description:
    'Review the terms and conditions for using Meetvia professional companionship and visitor assistance services.',
  openGraph: {
    title: 'Terms of Service | Meetvia',
    description:
      'Review the terms and conditions for using Meetvia professional companionship and visitor assistance services.',
    type: 'website',
    images: [{ url: 'https://meetvia.com/og-image.png', width: 1200, height: 630, alt: 'Meetvia Terms of Service' }],
  },
};
