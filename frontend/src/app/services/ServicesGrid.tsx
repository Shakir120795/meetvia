          ...
          <GlassCard className="p-6 h-full flex flex-col">
            {service.video && (
              <div className="relative mb-4 rounded-lg overflow-hidden aspect-video bg-secondary/20">
                {service.thumbnail ? (
                  <img src={service.thumbnail} alt={`${service.title} preview`} className="w-full h-full object-cover" />
                ) : (
            ...
            <p className="text-primary/70 text-sm leading-relaxed mb-4">{service.description}</p>
            ...
            {service.whatsIncluded && service.whatsIncluded.length > 0 && (
              <div className="mb-6 flex-1">
                <p className="text-xs font-medium text-primary/50 uppercase tracking-wider mb-2">What&apos;s Included</p>
            ...
            <div className="mt-auto pt-4">
              <Button href={service.buttonLink || '/contact'} variant="primary" size="md" className="w-full">
