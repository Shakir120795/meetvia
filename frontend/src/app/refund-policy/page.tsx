...
export const metadata: Metadata = {
  title: 'Refund Policy | Meetvia',
  description:
    'Understand our refund and cancellation policy for Meetvia services.',
  openGraph: {
    title: 'Refund Policy | Meetvia',
    description:
      'Understand our refund and cancellation policy for Meetvia services.',
    type: 'website',
    images: [{ url: 'https://meetvia.com/og-image.png', width: 1200, height: 630, alt: 'Meetvia Refund Policy' }],
  },
};
