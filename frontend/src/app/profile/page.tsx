...
export default function ProfilePage() {
  ...
  if (!isAuthenticated) return <section className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4"><div className="glass rounded-2xl p-8 text-center max-w-md w-full"><h1 className="text-2xl font-bold">Your GoWith profile</h1><p className="mt-2 text-foreground/60">Sign in to view and manage your profile.</p><Link href="/login" className="inline-block mt-6 rounded-xl bg-accent px-5 py-3 font-semibold text-white">Sign in</Link></div></section>;
  ...
  return <section className="min-h-[calc(100vh-4rem)] px-4 py-16"><div className="mx-auto max-w-3xl space-y-6">
    ...
    <form onSubmit={save} className="glass rounded-2xl p-6 sm:p-8 space-y-5"><div><h2 className="text-xl font-semibold">Edit profile</h2><p className="mt-1 text-sm text-foreground/60">Update the information shown on your GoWith profile.</p></div>
