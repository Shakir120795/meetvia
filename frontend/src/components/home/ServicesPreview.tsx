      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-primary/70 text-lg max-w-2xl mx-auto">
            Structured public experiences designed for domestic and international
            visitors seeking city assistance and companionship services.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              <GlassCard className="p-6 h-full flex flex-col">
                ...
                <p className="text-primary/70 text-sm leading-relaxed mb-4 flex-1">
                  {service.description}
                </p>
