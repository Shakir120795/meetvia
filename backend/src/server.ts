...
import publicTripMembersRoutes from './routes/public/tripMembers';
import publicTripItineraryRoutes from './routes/public/tripItinerary';
import publicTravelGroupsRoutes from './routes/public/travelGroups';
import publicInternationalTravelRoutes from './routes/public/internationalTravel';
import publicWaitlistsRoutes from './routes/public/waitlists';
import publicTripCheckInsRoutes from './routes/public/tripCheckIns';
...
app.use('/api/v1/public/trip-members', publicTripMembersRoutes);
app.use('/api/v1/public/trip-itinerary', publicTripItineraryRoutes);
app.use('/api/v1/public/travel-groups', publicTravelGroupsRoutes);
app.use('/api/v1/public/international-travel', publicInternationalTravelRoutes);
app.use('/api/v1/public/waitlists', publicWaitlistsRoutes);
app.use('/api/v1/public/trip-checkins', publicTripCheckInsRoutes);
